...
let a;
    ...
    //REFRESH DA TABELA    
    function read() {
        fetch('http://127.0.0.1:3000/operationals', {
...
var username;
    ...
    function editOperacional() {
       ...
       try{
            ...
            fetch('http://127.0.0.1:3000/'+ id_operacional +'/teams/'+ id_equipa, {
                headers: { 'Content-Type': 'application/json' },
                method: 'PUT',
            ...
            if(success == false){
                ...
                try{
                    ...
                    fetch('http://127.0.0.1:3000/operationals/'+ id_operacional +'/schedule', {
                        headers: { 'Content-Type': 'application/json' },
                        method: 'PUT',
                        body: JSON.stringify(data),
                        credentials: "include"
