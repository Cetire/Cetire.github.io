    ...
    function readTop3Local() {
        fetch('http://127.0.0.1:3000/dashboard/Top3Local', {
    ...
    function readNumPorNivel() {
        fetch('http://127.0.0.1:3000/dashboard/NumPorNivel', {
            headers: { 'Content-Type': 'application/json' },
            mode: 'cors',
            method: 'GET',
            credentials: "include"
    ...
    function getOperacionaisAtivos() {
        fetch('http://127.0.0.1:3000/dashboard/OperacionaisAtivos', {
            headers: { 'Content-Type': 'application/json' },
            mode: 'cors',
            method: 'GET',
            credentials: "include"
    ...
    function readOcorrenciasAno() {
        fetch('http://127.0.0.1:3000/OcorenciasAno', {
            headers: { 'Content-Type': 'application/json' },
            mode: 'cors',
            method: 'GET',
            credentials: "include"
