...
function readOcorenciasProgress() {
    fetch('http://127.0.0.1:3000/occurrencesInProgress', {
                ...
                for(let a = 0; a < count; a++){
                    ...
                    if(a == 1){
                        ...
                        function getLocal(id_local) {
                            fetch('http://127.0.0.1:3000/local/'+id_local, {
                                headers: { 'Content-Type': 'application/json' },
                                mode: 'cors',
                                method: 'GET',
                                credentials: "include"
...
try{
    fetch("http://127.0.0.1:3000/usersProfile", {
        headers: { 'Content-Type': 'application/json' },
        method: 'GET',
        credentials: "include"
    }).then(res => {
...
function readOcorenciasHold() {
    fetch('http://127.0.0.1:3000/occurrencesOnHold', {
        headers: { 'Content-Type': 'application/json' },
        mode: 'cors',
        method: 'GET',
        credentials: "include"
...
function readOcorenciasFinish() {
    fetch('http://127.0.0.1:3000/occurrencesFinished', {
        headers: { 'Content-Type': 'application/json' },
        mode: 'cors',
        method: 'GET',
        credentials: "include"
