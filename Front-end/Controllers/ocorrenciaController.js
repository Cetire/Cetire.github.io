...
function readID(id) {
    ...
    fetch('http://127.0.0.1:3000/occurrences/'+id , {
...
function readMaterial() {
    fetch('http://127.0.0.1:3000/materials', {
        headers: { 'Content-Type': 'application/json' },
        mode: 'cors',
        method: 'GET',
        credentials: "include"
...
function readVoluntario() {
    fetch('http://127.0.0.1:3000/volunteersAvailable', {
        headers: { 'Content-Type': 'application/json' },
        mode: 'cors',
        method: 'GET',
        credentials: "include"
...
function readEquipas() {
    fetch('http://127.0.0.1:3000/teamsAvailable', {
        headers: { 'Content-Type': 'application/json' },
        mode: 'cors',
        method: 'GET',
        credentials: "include"
                ...
                for(let a = 0; a < count; a++){
                    ...
                    if(a == 2){
                        function getMembros(id_equipa) {
                            fetch('http://127.0.0.1:3000/'+id_equipa, {
                                headers: { 'Content-Type': 'application/json' },
                                mode: 'cors',
                                method: 'GET',
                                credentials: "include"
...
function registerVoluntarioOcurrencia() {
    ...
    try{
        fetch('http://127.0.0.1:3000/'+id+'/volunteers/'+id_voluntario, {
            headers: { 'Content-Type': 'application/json' },
            method: 'POST',
...
function updateOcorrenciaTeam() {
  ...
  try{
        fetch("http://127.0.0.1:3000/"+ id +"/teams/" + id_equipa, {
            headers: { 'Content-Type': 'application/json' },
            method: 'PUT',
            body: JSON.stringify(data),
            credentials: "include"
...
function AceptOcorrencia() {
    ...
    try{
        fetch("http://127.0.0.1:3000/" + id + "/accept", {
            headers: { 'Content-Type': 'application/json' },
            method: 'PUT',
            body: JSON.stringify(data),
            credentials: "include"
...
function registerMaterialOcurrencia() {
  ...
  try{
        fetch('http://127.0.0.1:3000/'+id+'/materials/'+id_material, {
            headers: { 'Content-Type': 'application/json' },
            method: 'POST',
            body: JSON.stringify(data),
            credentials: "include"
